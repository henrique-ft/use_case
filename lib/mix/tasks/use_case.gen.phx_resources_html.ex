defmodule Mix.Tasks.UseCase.Gen.PhxResourceHtml do
  ...
  defp create_edit_html(context, schema) do
    copy_template("edit.html.eex", "lib/#{context[:web_path]}/templates/#{context[:path]}/edit.html.eex",
      schema: schema
    )
  end

  defp create_form_html(context, schema) do
    copy_template("form.html.eex", "lib/#{context[:web_path]}/templates/#{context[:path]}/form.html.eex",
      schema: schema,
  ...
  defp create_index_html(context, schema) do
    copy_template("index.html.eex", "lib/#{context[:web_path]}/templates/#{context[:path]}/index.html.eex",
      schema: schema
    )
  end

  defp create_new_html(context, schema) do
    copy_template("new.html.eex", "lib/#{context[:web_path]}/templates/#{context[:path]}/new.html.eex",
      schema: schema
    )
  end

  defp create_show_html(context, schema) do
    copy_template("show.html.eex", "lib/#{context[:web_path]}/templates/#{context[:path]}/show.html.eex",
      schema: schema
    )
  end
