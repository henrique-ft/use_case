defmodule Mix.Tasks.UseCase.Gen.PhxResourceTemple do
  @shortdoc "Generates context, schema, migration, controllers, temple templates, views and tests for a resource"
  @moduledoc """
    Generates context, schema, migration, controllers, temple templates, views and tests for a resource.
  ...
  @template_path "use_case.gen.phx_resource_temple"
  ...
  defp create_edit_html(context_inflected, schema) do
    path =
      "lib/#{context_inflected[:web_path]}/templates/#{context_inflected[:path]}/edit.html.exs"

    copy_template(@template_path, "temple/edit.html.eex", path,
      schema: schema
    )
  end
  ...
  defp create_form_html(context_inflected, schema) do
    path =
      "lib/#{context_inflected[:web_path]}/templates/#{context_inflected[:path]}/form.html.exs"

    copy_template(@template_path, "temple/form.html.eex", path,
      schema: schema,
  ...
  defp create_index_html(context_inflected, schema) do
    path =
      "lib/#{context_inflected[:web_path]}/templates/#{context_inflected[:path]}/index.html.exs"

    copy_template(@template_path, "temple/index.html.eex", path,
      schema: schema
    )
  end
  ...
  defp create_new_html(context_inflected, schema) do
    path =
      "lib/#{context_inflected[:web_path]}/templates/#{context_inflected[:path]}/new.html.exs"

    copy_template(@template_path, "temple/new.html.eex", path,
      schema: schema
    )
  end
  ...
  defp create_show_html(context_inflected, schema) do
    path =
      "lib/#{context_inflected[:web_path]}/templates/#{context_inflected[:path]}/show.html.exs"

    copy_template(@template_path, "temple/show.html.exs", path,
      schema: schema
    )
  end
