defmodule Mix.Tasks.UseCase.Gen.PhxResourceTemple do
  ...
  defp create_edit_html(context_inflected, schema) do
    path =
      "lib/#{context_inflected[:web_path]}/templates/#{schema.singular}/edit.html.exs"
  ...
  defp create_form_html(context_inflected, schema) do
    path =
      "lib/#{context_inflected[:web_path]}/templates/#{schema.singular}/form.html.exs"
  ...
  defp create_index_html(context_inflected, schema) do
    path =
      "lib/#{context_inflected[:web_path]}/templates/#{schema.singular}/index.html.exs"
  ...
  defp create_new_html(context_inflected, schema) do
    path =
      "lib/#{context_inflected[:web_path]}/templates/#{schema.singular}/new.html.exs"
  ...
  defp create_show_html(context_inflected, schema) do
    path =
      "lib/#{context_inflected[:web_path]}/templates/#{schema.singular}/show.html.exs"
